    ...
    <div className="about-page">
      <section className="hero bg-zinc-900 py-16">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About TheraGuild</h1>
          <p className="text-xl text-zinc-600 mb-8">
            Discover the world of tarantulas with TheraGuild, the premier platform for tarantula enthusiasts worldwide.
          </p>
        </div>
      </section>
          ...
          <div className="founder-profile flex flex-col md:flex-row items-center">
            ...
            <div>
              ...
              <p className="text-zinc-600 mt-4">
                As a passionate tarantula enthusiast, I founded TheraGuild to create a platform that brings together tarantula lovers from around the world. My goal is to foster a community where knowledge is shared, experiences are celebrated, and the beauty of these incredible creatures is appreciated by all.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="community py-16">
        <div className="container mx-auto">
          ...
          <p className="text-xl text-zinc-600 mb-8">
            At TheraGuild, our community is the heart and soul of our platform. Our members are the true tarantula experts, sharing their knowledge, experiences, and passion with others. From beginners to seasoned enthusiasts, everyone has a place in our welcoming and inclusive community.
          </p>
